...
#include <fstream>
#else
#include <goose-autocomplete/inlined_grammar.h>
#endif
...
namespace goose {
    ...
    public:
        ...
        SuggestionType AddSuggestionInternal(MatchState &state) const override {
            AutoCompleteCandidate candidate(keyword, SuggestionState::SUGGEST_KEYWORD, score_bonus,
    ...
    public:
        ...
        explicit ChoiceMatcher(vector<reference<Matcher> > matchers_p) : Matcher(TYPE),
                                                                         matchers(std::move(matchers_p)) {
        }
        ...
        bool MatchIdentifier(MatchState &state) const {
            ...
            switch (suggestion_type) {
                ...
                default: {
                    ...
                    const bool has_extra_banned_category = keyword_helper.KeywordCategoryType(
                        token_text, banned_category);
                    ...
                    const bool has_override_flag = keyword_helper.KeywordCategoryType(
                        token_text, allowed_override_category);
    ...
    struct MatcherListEntry {
        ...
        MatcherListEntry(Matcher &matcher, string_t function_name_p) : matcher(matcher),
    ...
    public:
        ...
        void CloseBracket() {
            ...
            if (root_bracket_matcher.function_name.GetSize() == 0) {
                ...
                auto &parameter = function_parameters.matchers.size() == 1
                                      ? function_parameters.matchers[0].get()
