...
#include <goose-autocomplete/tokenizer.h>
#include <goose-autocomplete/transformer/parse_result.h>
#include <goose-autocomplete/transformer/transform_enum_result.h>
#include <goose-autocomplete/transformer/transform_result.h>
#include <goose-autocomplete/ast/add_column_entry.h>
#include <goose-autocomplete/ast/column_elements.h>
#include <goose-autocomplete/ast/create_table_as.h>
#include <goose-autocomplete/ast/extension_repository_info.h>
#include <goose-autocomplete/ast/generic_copy_option.h>
#include <goose-autocomplete/ast/insert_values.h>
#include <goose-autocomplete/ast/join_prefix.h>
#include <goose-autocomplete/ast/join_qualifier.h>
#include <goose-autocomplete/ast/macro_parameter.h>
#include <goose-autocomplete/ast/on_conflict_expression_target.h>
#include <goose-autocomplete/ast/sequence_option.h>
#include <goose-autocomplete/ast/setting_info.h>
...
#include <goose-autocomplete/parser/peg_parser.h>
...
namespace goose {
    ...
    public:
        ...
        PEGTransformer(ArenaAllocator &allocator, PEGTransformerState &state,
            ...
            : allocator(allocator), state(state), grammar_rules(grammar_rules),
        ...
        T Transform(optional_ptr<ParseResult> parse_result) {
            ...
            if (!typed_result_ptr) {
                throw InternalException(
                    "Transformer for rule '" + parse_result->name + "' returned an unexpected type.");
            }
    ...
    private:
        ...
        static int64_t
        TransformSquareBracketsArray(PEGTransformer &transformer, optional_ptr<ParseResult> parse_result);
        ...
        static LogicalTypeId TransformTimeOrTimestamp(PEGTransformer &transformer,
                                                      optional_ptr<ParseResult> parse_result);

        static LogicalType TransformNumericType(PEGTransformer &transformer, optional_ptr<ParseResult> parse_result);

        static LogicalType TransformSimpleNumericType(PEGTransformer &transformer,
                                                      optional_ptr<ParseResult> parse_result);

        static LogicalType TransformDecimalNumericType(PEGTransformer &transformer,
                                                       optional_ptr<ParseResult> parse_result);
        ...
        static LogicalType TransformIntervalInterval(PEGTransformer &transformer,
                                                     optional_ptr<ParseResult> parse_result);
        ...
        static GenericCopyOption TransformSingleOption(PEGTransformer &transformer,
                                                       optional_ptr<ParseResult> parse_result);
        ...
        static pair<string, Value> TransformRelOption(PEGTransformer &transformer,
                                                      optional_ptr<ParseResult> parse_result);
        ...
        static string TransformSecretStorageSpecifier(PEGTransformer &transformer,
                                                      optional_ptr<ParseResult> parse_result);
        ...
        static SecretPersistType
        TransformTemporary(PEGTransformer &transformer, optional_ptr<ParseResult> parse_result);
        ...
        static CreateTableAs
        TransformCreateTableAs(PEGTransformer &transformer, optional_ptr<ParseResult> parse_result);
        ...
        TransformColumnIdList(PEGTransformer &transformer, optional_ptr<ParseResult> parse_result);
        ...
        static LogicalType
        TransformTypeOrGenerated(PEGTransformer &transformer, optional_ptr<ParseResult> parse_result);
        ...
        static ExpressionType TransformLambdaOperator(PEGTransformer &transformer,
                                                      optional_ptr<ParseResult> parse_result);
        ...
        static ExpressionType TransformBetweenOperator(PEGTransformer &transformer,
                                                       optional_ptr<ParseResult> parse_result);
        ...
        static string
        TransformCatalogQualification(PEGTransformer &transformer, optional_ptr<ParseResult> parse_result);

        static QualifiedName
        TransformQualifiedName(PEGTransformer &transformer, optional_ptr<ParseResult> parse_result);
        ...
        static vector<OrderByNode> TransformOrderByAll(PEGTransformer &transformer,
                                                       optional_ptr<ParseResult> parse_result);

        static OrderByNode TransformOrderByExpression(PEGTransformer &transformer,
                                                      optional_ptr<ParseResult> parse_result);
        ...
        static unique_ptr<TableRef> TransformTableRef(PEGTransformer &transformer,
                                                      optional_ptr<ParseResult> parse_result);
        ...
        static JoinQualifier
        TransformJoinQualifier(PEGTransformer &transformer, optional_ptr<ParseResult> parse_result);
        ...
        static JoinPrefix TransformNaturalJoinPrefix(PEGTransformer &transformer,
                                                     optional_ptr<ParseResult> parse_result);
        ...
        static unique_ptr<AtClause> TransformAtClause(PEGTransformer &transformer,
                                                      optional_ptr<ParseResult> parse_result);
        ...
        static unique_ptr<TransactionStatement> TransformRollbackTransaction(
            PEGTransformer &, optional_ptr<ParseResult>);
